...
2. Read this file and then read `DECISIONS.md` if it is added later before non-trivial work. These files are operational rules, not background reading.
